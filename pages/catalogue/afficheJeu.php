...
<table id="affiche_resultat">
	...
	<tbody> 
		<tr>
			<td rowspan="2" class="photo"><img src="pages/catalogues/photos/<?= $jeu['photo'] ?>" alt="image du jeu <?= $jeu['nom'] ?>"/></td>
...
<h4>Commentaires de ce jeu (xx<!-- ajouter le code pour afficher le nombre de commentaires pour ce jeu -->)	</h4>
